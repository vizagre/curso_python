...
class ProdutoService:
    ...
    def criar_produto(self, nome: str, preco: float, ativo: bool):
        return  self._repo.criar(nome, preco, ativo)


    def atualizar_produto(self, id_: int, nome: str, preco: float, ativo: bool) -> Optional[Produto]:
        """
        Update a product by its ID.
        """
        return self._repo.atualizar(id_ = id_, nome = nome, preco = preco, ativo = ativo)
